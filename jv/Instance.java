...
public class Instance {
    ...
    public boolean isReleasable() {
        int cutoffPeriod;
        switch (_type) {
            case Ondemand: cutoffPeriod = ONDEMAND_CUTOFF_PERIOD; break;
            case Reserved: cutoffPeriod = RESERVED_CUTOFF_PERIOD; break;
    ...
    public float getCost() {
        ...
        return unitPrice * (_uptime * 1.0f / cutoffPeriod);
    }
